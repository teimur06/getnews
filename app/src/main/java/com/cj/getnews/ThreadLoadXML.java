...
import com.cj.getnews.MainActivity;
import com.cj.getnews.NewsAdapter;
import com.cj.getnews.NewsStruct;
...
class ThreadLoadXML extends AsyncTask<Void, Void, Void>
{
	...
	String localError = "";
	String host = "https://informburo.kz/xml/rss.xml";
	String XMLString= "";
	String line = "";
	String TEG_XML = "";
